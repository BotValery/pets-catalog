...
cron.schedule('0 6 * * *', async () => {
    console.log('⏰ Запуск автоматической синхронизации новостей...');
    try {
        const result = await syncNews();
        console.log('✅ Автоматическая синхронизация завершена:', result);
    } catch (error) {
...
console.log('📅 Автоматическая синхронизация новостей настроена (каждый день в 6:00)');
